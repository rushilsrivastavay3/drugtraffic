...
const embeds = require('../funcs/embeds.js');
...
module.exports = async (bot, msg) => {
    try {
        ...
        let blacklisted = db.get(`blacklist_${msg.author.id}`) //here the bot is searching if the person typing  is blacklisted

        if(blacklisted === 1) return msg.channel.send("Blacklisted from Hydra, to appeal DM py#0507."); //if it is blacklisted then you can return; 
